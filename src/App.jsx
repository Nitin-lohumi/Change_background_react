...
function App() {
  ...
  return (
    <>
      ...
      <button onClick={ ()=>setColor("green") } className='flex items-center px-4 py-3
       text-white bg-green-500 hover:bg-green-400 rounded m-10' style={{backgroundColor:"green",color:text}}>green</button>
